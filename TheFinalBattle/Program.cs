...
heroes.Items.Add(new HealthPotion());
heroes.Items.Add(new HealthPotion());
heroes.Items.Add(new SimulasSoup());
...
List<Party> monsterParties = new List<Party> { CreateMonsterPartyTest(player2) };
...
Party CreateMonsterPartyTest(IPlayer controllingPlayer)
{
    Party monsters = new Party(controllingPlayer);
    monsters.Characters.Add(new StoneAmarok());
    return monsters;
